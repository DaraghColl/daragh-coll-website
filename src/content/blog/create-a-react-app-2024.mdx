...
This article aims to be a simple, straightforward guide to setting up a react application in 2024. If you would just like to clone a repository with this setup, you can find the code 
<a target="_blank" href="https://vitejs.dev">in this github repository</a>.
...
This command will give you a walk through setup, giving you different setup options. See the options I have used below, but feel free to read more <a target="_blank" href="//eslint.org/docs/latest/use/configure">in the eslint docse</a> and configure your project differently.
