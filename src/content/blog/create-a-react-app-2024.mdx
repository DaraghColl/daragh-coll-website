...
This article aims to be a simple, straightforward guide to setting up a react application in 2024. If you would just like to clone a repository with this setup, you can find the code [in this github repository](https://vitejs.dev).
...
Once installed, create a **.prettierrc** file in the root of your project. In this file, we can put all the prettier config options we want to use. You can use the below options to get started. Read more about prettier config [on the prettier docs website](https://prettier.io/docs/en/options).
...
This command will give you a walk through setup, giving you different setup options. See the options I have used below, but feel free to read more [in the eslint docs](https://eslint.org/docs/latest/use/configure/) and configure your project differently.
